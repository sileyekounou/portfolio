    ...
    return (
        <>
            <div className=" w-full">
                <div className="flex h-[311px] bg-white justify-between space-x-4 rounded-[12px] p-[22px] ">

                    <div className=" w-[271.86px] h-[266.14px] rounded-lg ">
                    ...
                    <div className=" font-montserrat flex-1 ">
                        ...
                        <div className=" mt-[37px] w-[658.86px] ">

                            <p className=" text-[#828282] font-medium text-[18px] ">
                                Self-motivated developer, who is willing to learn and create outstanding UI applications.
                            </p>

                            <p className=" text-[#828282] font-medium text-[18px] mt-[20px] ">
